...
export const SectionTwo = () => {
  return (
    <section className="body-font text-white mx-10">
  <div className="container px-5 mx-auto bg-blue-600 rounded-3xl">
    <div className="flex flex-wrap w-full mb-2 flex-col items-center text-center">
      <h1 className="sm:text-5xl text-3xl uppercase font-medium title-font mt-12">Kurs kimlar uchun?</h1>
    </div>
    <div className="flex flex-wrap md:px-20 pb-12">
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-blue-300 min-h-48 bg-blue-500 p-6 rounded-2xl">
          <h2 className="text-sm font-bold title-font mb-2">Mantiqiy va tanqidiy fikrlovchilar uchun </h2>
          <p className="leading-relaxed text-sm">BI mutaxassislari maʼlumotlar bazasi bilan ishlaganliklari uchun ulardan mantiqiy va tanqidiy fikrlash talab qilinadi.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-blue-300 min-h-48 bg-blue-500 p-6 rounded-2xl">
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-blue-300 min-h-48 bg-blue-500 p-6 rounded-2xl">
          <h2 className="text-sm font-bold title-font mb-2">Tezroq daromadga chiqishni xohlovchilar uchun</h2>
          <p className="leading-relaxed text-sm">10 oyda kursni bitirib, BI mutaxassisiga aylanish orqali tezda daromadli kasb egasina aylanishiningiz mumkin.</p>
        </div>
      </div>
    </div>
  </div>
